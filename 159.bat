...
echo %dat%
echo "image_unsigned: "%image_unsigned%
for /f %%a in ("%image_unsigned%") do (
	set image_unsigned_filename=%%~nxa
)
echo image_unsigned_filename : %image_unsigned_filename%
set image_unsigned_1_and_2=%temp%\%image_unsigned_filename%_part12_%dat%
echo image_unsigned_1_and_2 : %image_unsigned_1_and_2%
set image_unsigned_1_and_2_and_3=%temp%\%image_unsigned_filename%_part123_%dat%
echo image_unsigned_1_and_2_and_3 : %image_unsigned_1_and_2_and_3%


:: combine part1 & unsigned.img
type %image_signed_1% %image_unsigned% > %image_unsigned_1_and_2%
